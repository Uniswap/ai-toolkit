...
| Slack summary items                  | SINGLE LINE: `1. **Title** - "excerpt..." [→ thread](url) • X reactions` | ☐     |
| Tool updates header                  | `**Releases This Week:**` (bold)                                         | ☐     |
| Tool updates list                    | COMPACT: `@package/name → vX.Y.Z` (one per line, no dates/links)         | ☐     |
...
- ❌ Slack items on multiple lines: `1.\n**Title**` should be `1. **Title** - "excerpt..."`
- ❌ Verbose tool updates with dates/links per release - keep it compact
