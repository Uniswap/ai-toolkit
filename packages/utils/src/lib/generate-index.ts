...
export interface GenerateIndexOptions {
  srcPath: string;
  outputPath: string;
  typeName: string; // 'Agent', 'CommandName', or 'SkillName'
  exportName: string; // 'agents', 'commands', or 'skills'
  typeNamePlural?: string; // 'Agents', 'Commands', or 'Skills'
...
export async function generateIndex(
  ...
  // Skills and agents use 'name' field in frontmatter
  ...
  if (typeName === 'Agent') {
    indexContent = `// Auto-generated file - DO NOT EDIT
...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  if (args.length < 4) {
    ...
    console.error('  type: "Agent", "CommandName", or "SkillName"');
    console.error('  exportName: "agents", "commands", or "skills"');
    process.exit(1);
  }
